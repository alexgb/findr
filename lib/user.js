...
/*
  TODO  - needs to fire update location event that returns client
        - needs to fire new friends event that returns client and new friends
        - or can I just fire a single update event that returns client
*/
